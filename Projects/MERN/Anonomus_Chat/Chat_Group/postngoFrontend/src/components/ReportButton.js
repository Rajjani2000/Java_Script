...
import { reportPost } from "../services/http";
    ...
    return (
      <div className="comment-container">
        {this.state.reports.map((data) => (
          <div className="comment-item" key={data._id} style={{color: "var(--accent-color-red)"}}>
            {"This post has been reported. Reason: "}<p>{ data.reason ? data.reason : ""}</p>
          </div>
        ))}
