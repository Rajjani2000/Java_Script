...
class Studentlogin extends Component {
  ...
  render() {
    const { classroomname, classroompassword, loginError, empty, manageClassroom } = this.state;

    return (
      <>
        {this.state.flag && <Navigate to="./Studentview" replace={true} state={{ manageClassroom }} />}
